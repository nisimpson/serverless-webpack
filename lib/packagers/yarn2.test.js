  ...
  describe('getProdDependencies', () => {
    ...
    it('should transform yarn trees to npm dependencies', () => {
      const testYarnResult = [
        '{"value":"@protobufjs/aspromise@npm:1.1.2","children":{"Version":"1.1.2"}}',
        '{"value":"@protobufjs/fetch@npm:1.1.0","children":{"Version":"1.1.0",' +
          '"Dependencies":[{"descriptor":"@protobufjs/aspromise@npm:^1.1.1",' +
          '"locator":"@protobufjs/aspromise@npm:1.1.2"},' +
          '{"descriptor":"@protobufjs/inquire@npm:^1.1.0",' +
          '"locator":"@protobufjs/inquire@npm:1.1.0"}]}}',
        '{"value":"@protobufjs/float@npm:1.0.2","children":{"Version":"1.0.2"}}',
        '{"value":"@protobufjs/inquire@npm:1.1.0","children":{"Version":"1.1.0"}}',
        '{"value":"@protobufjs/path@npm:1.1.2","children":{"Version":"1.1.2"}}',
        '{"value":"@protobufjs/pool@npm:1.1.0","children":{"Version":"1.1.0"}}',
        '{"value":"@protobufjs/utf8@npm:1.1.0","children":{"Version":"1.1.0"}}'
      ].join('\n');
  ...
  describe('install', () => {
    ...
    it('should use noFrozenLockfile option', () => {
      ...
      return expect(yarnModule.install('myPath', { noFrozenLockfile: true })).to.be.fulfilled.then(result => {
        expect(result).to.be.undefined;
        expect(Utils.spawnProcess).to.have.been.calledOnce;
        expect(Utils.spawnProcess).to.have.been.calledWithExactly(sinon.match(/^yarn/), ['install'], {
          cwd: 'myPath'
        });
        return null;
      });
    ...
    it('should use networkConcurrency option', () => {
      ...
      return expect(yarnModule.install('myPath', { networkConcurrency: 1 })).to.be.fulfilled.then(result => {
        ...
        expect(Utils.spawnProcess).to.have.been.calledWithExactly(
          sinon.match(/^yarn/),
          [ 'install', '--frozen-lockfile', '--network-concurrency 1' ],
          {
            cwd: 'myPath'
          }
        );
